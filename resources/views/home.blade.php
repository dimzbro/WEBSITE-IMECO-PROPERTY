...
<section id="hero" class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden">
        <img id="hero-bg"
             src="{{ $images['heroBg'] }}"
             alt="Beltway Office Park - Premium Corporate Building"
    ...
    <div class="absolute inset-0 pointer-events-none">
        <div class="absolute top-20 right-20 w-64 h-64 rounded-full opacity-10" style="background: radial-gradient(circle, #D4AF37, transparent);"></div>
        <div class="absolute bottom-40 left-10 w-48 h-48 rounded-full opacity-8" style="background: radial-gradient(circle, #1E3A8A, transparent);"></div>
    </div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 text-center pt-24">
        ...
        <div class="flex flex-wrap justify-center gap-8 fade-up delay-400">
            <div class="text-center">
                <div class="text-3xl font-black text-white">4,500</div>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative fade-left">
                <div class="relative rounded-2xl overflow-hidden shadow-2xl" style="box-shadow: 0 32px 80px rgba(30, 58, 138, 0.2);">
                    <img src="{{ $images['aerial'] }}"
                         alt="Beltway Office Park Aerial View"
                         class="w-full h-[500px] object-cover">
                    <div class="absolute inset-0" style="background: linear-gradient(to top right, rgba(30,58,138,0.3), transparent);"></div>
                </div>
                {{-- Floating badge --}}
                <div class="absolute -bottom-6 -right-6 p-5 rounded-2xl shadow-xl z-10" style="background: linear-gradient(135deg, #1E3A8A, #0F172A);">
                    <div class="text-center">
                        <div class="text-4xl font-black text-white">25<span style="color: #D4AF37;">+</span></div>
                        <div class="text-xs font-bold uppercase tracking-widest mt-1" style="color: rgba(255,255,255,0.7);">Years Excellence</div>
                    </div>
                </div>
                {{-- Decorative square --}}
                <div class="absolute -top-6 -left-6 w-32 h-32 rounded-2xl opacity-20 -z-10" style="background: #D4AF37;"></div>
            </div>
...
<section id="towers" class="py-24 px-6 lg:px-12 bg-section-alt overflow-hidden">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16">
            <div class="flex justify-center"><div class="section-tag fade-up">Our Office Towers</div></div>
            ...
            <p class="text-gray-600 max-w-xl mx-auto fade-up delay-300">
                Each tower is architecturally distinct, purpose-built to serve different business needs with world-class amenities and premium finishes.
            </p>
        </div>
                ...
                <div class="tower-card-body">
                    ...
                    <div class="flex gap-4 mb-4">
                        <div class="flex items-center gap-1.5 text-xs font-semibold text-gray-500">
                            <svg class="w-3.5 h-3.5" style="color: #1E3A8A;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section id="why" class="py-24 px-6 lg:px-12 bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto">
        ...
        {{-- Header --}}
        <div class="text-center mb-16">
            <div class="flex justify-center"><div class="section-tag fade-up">Why Choose Us</div></div>
...
<section id="facilities" class="py-24 px-6 lg:px-12 overflow-hidden" style="background: #F8FAFC;">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16">
            <div class="flex justify-center"><div class="section-tag fade-up">Facilities & Amenities</div></div>
            ...
            <div class="facility-card fade-up delay-{{ min(($i + 1) * 100, 500) }}" id="facility-{{ $i }}">
                <div class="facility-icon-wrap">
                    ...
                    $facilityIcons = [
                        ...
                        'parking' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>',
...
<section id="location" class="py-24 px-6 lg:px-12 relative overflow-hidden">
    <div class="absolute inset-0">
        ...
        <div class="absolute inset-0" style="background: linear-gradient(135deg, rgba(15,23,42,0.92) 0%, rgba(30,58,138,0.85) 100%);"></div>
    </div>
    <div class="relative z-10 max-w-7xl mx-auto">

        <div class="text-center mb-14">
            <div class="flex justify-center"><div class="section-tag" style="color: #D4AF37;">Location Advantage</div></div>
            <h2 class="text-white fade-up delay-100" style="font-size: clamp(1.75rem, 4vw, 3rem); font-weight: 800; line-height: 1.15; letter-spacing: -0.02em;">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="location-card fade-up delay-{{ min(($i + 1) * 100, 500) }}" id="location-benefit-{{ $i }}">
                    <div class="flex items-start gap-3">
                        <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background: rgba(212,175,55,0.15); border: 1px solid rgba(212,175,55,0.3);">
                        ...
                        <div>
                            ...
                            <div class="text-xs leading-relaxed" style="color: rgba(255,255,255,0.65);">{{ $benefit['desc'] }}</div>
                        </div>
                    </div>
                </div>
                @endforeach
            ...
            <div class="fade-right">
                <div class="map-container">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31714.545614789264!2d106.78454585!3d-6.28979175!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f1490b9cf4b9%3A0x5fc2b03d4cebbe5c!2sJakarta%20Selatan%2C%20Kota%20Jakarta%20Selatan%2C%20Daerah%20Khusus%20Ibukota%20Jakarta!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid"
                        width="100%"
                        height="400"
                        ...
                        title="Beltway Office Park Location Map"
                        id="location-map">
                    </iframe>
                </div>
                <div class="mt-4 p-4 rounded-xl flex items-center gap-3" style="background: rgba(212,175,55,0.1); border: 1px solid rgba(212,175,55,0.25);">
                    ...
                    <div>
                        ...
                        <div class="text-xs" style="color: rgba(255,255,255,0.65);">Jakarta Selatan 12560, DKI Jakarta</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12 fade-up">
            <div>
                ...
                <h2 class="text-gray-900 font-extrabold" style="font-size: clamp(1.75rem, 4vw, 2.5rem); line-height: 1.15; letter-spacing: -0.02em;">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" id="spaces-grid">
            ...
            <div class="space-listing-card fade-up delay-{{ min(($i + 1) * 100, 500) }}"
                 data-filter="{{ $space['filter'] }}"
                 id="space-listing-{{ $i }}">

                {{-- Image with Status Badge --}}
                <div class="relative overflow-hidden" style="height: 230px; border-radius: 12px 12px 0 0;">
                    <img src="{{ $space['image'] }}"
                         alt="{{ $space['tower'] }} – {{ $space['floor'] }}"
                         class="w-full h-full object-cover space-listing-img"
                         loading="lazy">
                ...
                <div class="space-listing-body">
                    ...
                    <div class="flex items-center gap-1.5 text-sm text-gray-500 mb-2">
                        <svg class="w-4 h-4 flex-shrink-0" style="color: #1E3A8A;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                        </svg>
                    ...
                    <div class="flex gap-3 mt-auto">
                        <button class="space-btn-outline flex-1" onclick="document.getElementById('contact').scrollIntoView({behavior:'smooth'})"
                                id="floorplan-btn-{{ $i }}">
                            View Floor Plan
                        </button>
                        <button class="space-btn-solid flex-1" onclick="document.getElementById('contact').scrollIntoView({behavior:'smooth'})"
                                id="reqinfo-btn-{{ $i }}">
                            Request Info
                        </button>
                    </div>
...
<section id="gallery" class="py-24 px-6 lg:px-12 overflow-hidden" style="background: #F8FAFC;">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16">
            <div class="flex justify-center"><div class="section-tag fade-up">Gallery</div></div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4" id="gallery-grid">
            ...
            <div class="gallery-item fade-up delay-{{ min(($i + 1) * 100, 500) }} {{ $item['span'] === 'large' ? 'md:col-span-2 row-span-1' : '' }}"
                 style="height: {{ $item['span'] === 'large' ? '320px' : '240px' }};"
                 id="gallery-item-{{ $i }}"
                 role="button"
                 tabindex="0"
...
<section id="tenants" class="py-20 px-6 lg:px-12 bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-12">
            <div class="flex justify-center"><div class="section-tag fade-up">Our Tenants</div></div>
            <h2 class="section-title fade-up delay-100">Trusted by<br><span>Leading Companies</span></h2>
            <div class="section-divider mx-auto fade-up delay-200"></div>
        </div>

        {{-- Carousel --}}
        <div class="relative overflow-hidden fade-up delay-300">
            {{-- Gradient masks --}}
            <div class="absolute left-0 top-0 bottom-0 w-16 z-10 pointer-events-none" style="background: linear-gradient(to right, white, transparent);"></div>
            <div class="absolute right-0 top-0 bottom-0 w-16 z-10 pointer-events-none" style="background: linear-gradient(to left, white, transparent);"></div>

            <div id="tenant-carousel" class="tenant-track">
                @php $duplicatedTenants = array_merge($tenants, $tenants); @endphp
                @foreach($duplicatedTenants as $i => $tenant)
                <div class="tenant-logo-card" id="tenant-{{ $i }}">
        ...
        <div class="text-center mt-10 fade-up delay-400">
            <p class="text-gray-500 text-sm">
                Bergabung dengan <span class="font-bold" style="color: #1E3A8A;">100+ perusahaan</span> yang telah mempercayakan kebutuhan kantor mereka kepada kami.
            </p>
        </div>
    </div>
</section>
...
<section id="contact" class="py-24 px-6 lg:px-12 bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="text-center mb-16">
            <div class="flex justify-center"><div class="section-tag fade-up">Get in Touch</div></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-14">
            ...
            <div class="fade-left">
                ...
                <div class="space-y-4 mb-10">
                    <div class="contact-info-item">
                        ...
                        <div>
                            ...
                            <div class="text-gray-500 text-sm mt-0.5">Jl. TB Simatupang Kav. 1, Jakarta Selatan 12560, DKI Jakarta, Indonesia</div>
                        </div>
                    </div>
                    <div class="contact-info-item">
                        <div class="contact-icon">
                    ...
                    <div class="contact-info-item">
                        ...
                        <div>
                            ...
                            <div class="text-gray-500 text-sm mt-0.5">info@beltwayofficepark.co.id</div>
                            <div class="text-gray-500 text-sm">leasing@beltwayofficepark.co.id</div>
                        </div>
                    </div>
                    <div class="contact-info-item">
                        <div class="contact-icon">
                ...
                <div class="relative rounded-2xl overflow-hidden" style="height: 200px;">
                    ...
                    <div class="absolute inset-0" style="background: linear-gradient(135deg, rgba(30,58,138,0.7), rgba(212,175,55,0.3));"></div>
            ...
            {{-- Right: Contact Form --}}
            <div class="fade-right">
                <div class="p-8 rounded-2xl border" style="box-shadow: 0 8px 40px rgba(15,23,42,0.1); border-color: rgba(30,58,138,0.1);">
                    ...
                    <form action="{{ route('contact') }}" method="POST" id="contact-form" novalidate>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                            {{-- Name --}}
                            <div>
                                <label for="contact-name" class="form-label">Full Name <span style="color: #dc2626;">*</span></label>
                                <input type="text"
                                       id="contact-name"
                                       name="name"
                                       value="{{ old('name') }}"
                        ...
                        {{-- Message --}}
                        <div class="mb-6">
                            <label for="contact-message" class="form-label">Message <span style="color: #dc2626;">*</span></label>
